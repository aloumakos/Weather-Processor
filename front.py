...
def serve_layout():
    ...
    children=[ dbc.Alert(id="countdown", color="primary"), dcc.Interval( id="interval-component-countdown", interval=100, n_intervals=0,),
        ...
        html.Div(id="table-output", style={'textAlign': 'center', 'paddingTop': '40px','paddingBottom': '40px','margin': 'auto',},className="table-size"),
        dcc.Interval(id="interval-component", interval=1 * 30 * 1000, n_intervals=0,),
        dcc.Interval(id="peepo-interval-component", interval=1 * 10 * 1000, n_intervals=0),
...
def update_table(n, tab_value, data):
    ...
    table = dash_table.DataTable(id="table",
                                 ...
                                 style_cell={'textAlign': 'center', 'fontFamily': 'Lucida Console,monospace','minWidth': '170px','border': '2px solid #3e423f'},
